...
export const MUSCLE_DETAIL: Record<string, MuscleTarget> = {
  ...
  // V5 additions
  'larsen-press': { primary: ['mid chest'], secondary: ['front delts', 'triceps'] },
  'spoto-press': { primary: ['mid chest'], secondary: ['front delts', 'triceps'] },
  'converging-chest-press': { primary: ['mid chest'], secondary: ['front delts', 'triceps'] },
  'decline-machine-press': { primary: ['lower chest'], secondary: ['triceps', 'front delts'] },
  'deficit-push-up': { primary: ['mid chest'], secondary: ['front delts', 'triceps', 'abs'] },
  'kroc-row': { primary: ['lats'], secondary: ['upper back', 'rear delts', 'biceps', 'forearm flexors'] },
  'helms-row': { primary: ['upper back', 'lats'], secondary: ['rear delts', 'biceps'] },
  'close-grip-lat-pulldown': { primary: ['lats'], secondary: ['biceps'] },
  'powell-raise': { primary: ['rear delts'], secondary: ['upper back'] },
  'cable-external-rotation': { primary: ['rear delts'], secondary: [] },
  'snatch-grip-high-pull': { primary: ['traps'], secondary: ['side delts', 'erectors', 'forearm flexors'] },
  'paused-back-squat': { primary: ['quads', 'glutes'], secondary: ['erectors', 'abs', 'adductors'] },
  'pin-squat': { primary: ['quads', 'glutes'], secondary: ['erectors', 'abs'] },
  'front-foot-elevated-split-squat': { primary: ['quads'], secondary: ['glutes', 'adductors', 'abs'] },
  'walking-barbell-lunge': { primary: ['quads', 'glutes'], secondary: ['hamstrings', 'erectors', 'abs'] },
  'unilateral-leg-extension': { primary: ['quads'], secondary: [] },
  'b-stance-hip-thrust': { primary: ['glutes'], secondary: ['hamstrings'] },
  'reverse-hyperextension': { primary: ['glutes'], secondary: ['hamstrings', 'erectors'] },
  'hack-squat-calf-raise': { primary: ['calves'], secondary: [] },
  'incline-cable-curl': { primary: ['biceps'], secondary: ['brachialis'] },
  'drag-curl': { primary: ['biceps'], secondary: ['brachialis'] },
  'waiter-curl': { primary: ['biceps'], secondary: ['forearm flexors'] },
  'zottman-curl': { primary: ['biceps', 'forearm extensors'], secondary: ['brachialis', 'forearm flexors'] },
  'tate-press': { primary: ['triceps'], secondary: [] },
  'rolling-tricep-extension': { primary: ['triceps'], secondary: ['lats'] },
